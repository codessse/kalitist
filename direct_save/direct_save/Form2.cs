...
namespace direct_save
{
    public partial class Form2 : Form
    {
        ...
        public void setBar(Dictionary<string, int> i_CTR_bar)
        {
            foreach (var OneItem in i_CTR_bar)
            {
                chart1.Series["CTR"].Points.AddXY(OneItem.Key, OneItem.Value);
            }
        }
